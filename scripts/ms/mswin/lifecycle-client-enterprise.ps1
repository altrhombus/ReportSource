...
$d4nData = Invoke-WebRequest "https://raw.githubusercontent.com/altrhombus/ReportSource/main/content/ms/mswin/lifecycle-client-enterprise.json" | Select-Object -ExpandProperty Content | ConvertFrom-Json

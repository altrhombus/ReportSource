...
$d4nData = Invoke-WebRequest "https://raw.githubusercontent.com/altrhombus/ReportSource/main/content/ms/mswin/lifecycle-server.json" | Select-Object -ExpandProperty Content | ConvertFrom-Json
